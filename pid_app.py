...
st.markdown("<p style='color:#5a6080;font-size:0.85rem;margin-top:-0.5rem'>Closed-loop PID response of a mass-spring-damper<br>" 
            "By Valmik Prabhu (and Claude)</p>", unsafe_allow_html=True)
